...
1. You have to write all the code in the Snwoflake Account.
2. Once you complete the project, you're expected to copy the code from the _**Snowflake Account**_ into the _**.sql**_ files of your local repositry.
3. You have push all the changes from the local repository to the remote repository.
